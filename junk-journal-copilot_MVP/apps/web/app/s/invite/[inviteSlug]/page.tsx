...
export default async function InviteSharePage({ params }: { params: { inviteSlug: string } }) {
  const data = await apiGet<any>(`/api/share/invite/${params.inviteSlug}`);

  return (
    <div className="space-y-6">
      <div className="p-6 rounded-2xl border border-black/10 bg-white/40">
        <div className="text-sm text-black/60">Invite Journal</div>
